...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Click the Start game button to Start and Play ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function start_game(){
  game_status = "start";
  document.getElementById("status_button").innerHTML = "Game is loading, get ready!";
}
